...
>
> **The Solution:** A stable symbol index, evidence-backed Python, JavaScript/TypeScript, and Go dependency graph, lifecycle-managed constraints (`.lcm/constraints.json`), and living Markdown projection. The CLI refreshes navigation locations without confusing line numbers with identity; commits remain explicit.
