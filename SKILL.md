...
>
> **The Solution:** A stable symbol index, AST-backed import-aware Python and JavaScript/TypeScript dependency graph, lifecycle-managed constraints (`.lcm/constraints.json`), and living Markdown projection. The CLI refreshes navigation locations without confusing line numbers with identity; commits remain explicit.
