...
| 🔷 **C# Graph Intelligence** | Class-qualified ranged methods, calls, xUnit/NUnit/MSTest links, ASP.NET controllers, and Minimal APIs become evidence-backed relationships. |
